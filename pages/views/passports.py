"""
Passport / Identity Document views for Alivente Online.

Extracted from pages/views/main.py as part of the modular split.
Contains the single ``passport_management`` view which handles
list / add / edit / upload / delete operations for personal identity
documents (passports, IDs, driver's licences, ARC cards, etc.).
"""
