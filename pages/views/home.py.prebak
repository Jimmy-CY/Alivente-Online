...
Contains 2 functions:
  _build_today_items - helper that builds the ordered list of non-zero
                        "Today" items for the home page panel
  home               - the home/landing page view

URL patterns remain registered in pages/urls.py.

Cross-module dependency: the home view calls get_notification_data() which
currently lives in the ### NOTIFICATIONS ### section of main.py. When that
section is later extracted into its own module, update the import below
