...
def import_celebrations(request):
    ...
    try:
        # pandas is imported lazily (not at module top) on purpose: it is a
        # heavy dependency and only this rarely-used Excel importer needs it,
        # so we avoid paying its import cost on every worker startup.
        import pandas as pd
