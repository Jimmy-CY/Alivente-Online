...
urlpatterns = [
    ...
    path('act_expense_analysis_data/', views.act_expense_analysis_data, name='act_expense_analysis_data'),
    ...
    path('issues-analysis-data/', views.issues_analysis_data, name='issues_analysis_data'),
    ...
    path('recipes/<int:recipe_id>/suggest_modification/', views.suggest_recipe_modification, name='suggest_recipe_modification'),
    # Meal Planning URLs
